...
const CricketEntry = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center bg-gradient-to-b from-gray-900 to-black text-white p-16" style={{ backgroundImage: "url('/static/batter.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
      <motion.button
